...
public class MovieDatabase {
	...
	public void insertData(Movie mov) {
		...
		newMovie.put(AppConfig.Data.IMAGE_KEY, mov.getImagePath());
	...
	public void removeMovie(Movie mov) {
		...
		String whereClause = AppConfig.Data.ID_KEY + " = '" + mov.getId()
				...
				+ mov.getPopularity() + "' AND " + AppConfig.Data.IMAGE_KEY
				+ " = '" + mov.getImagePath() + "'";
	...
	public ArrayList<Movie> getAllItems() {
		...
		Cursor cursor = db.query(AppConfig.Data.TABLE_KEY, new String[] {
				...
				AppConfig.Data.POPULAR_KEY, AppConfig.Data.IMAGE_KEY }, null, null, null, null, null);
		if (cursor.moveToFirst()) {
			do {
				...
				double popular = cursor.getDouble(4);
				String image = cursor.getString(5);

				items.add(new Movie(id, release_date, title, rating, popular, image));
	...
	private class LocationDatabaseHelper extends SQLiteOpenHelper {
		...
		private static final String DATABASE_CREATE = "create table "
				...
				+ AppConfig.Data.IMAGE_KEY + " text not null )";
